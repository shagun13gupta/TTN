...
namespace Q2
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        {
            Response.Write("QUES 2: Display the data into 3 tables from database using connection string in web.config with connection pooling and use Connected and disconnected architecture both.<br/><br>");
