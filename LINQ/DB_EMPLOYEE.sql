...
USE [DB_EMPLOYEE]
GO
/****** Object:  UserDefinedFunction [dbo].[GETNAME]    Script Date: 04-03-2020 22:55:07 ******/
SET ANSI_NULLS ON
GO
...
END
GO
/****** Object:  Table [dbo].[SALARY]    Script Date: 04-03-2020 22:55:07 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[salary_view]    Script Date: 04-03-2020 22:55:07 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
group by EMP_ID
GO
/****** Object:  Table [dbo].[test]    Script Date: 04-03-2020 22:55:07 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[test_view]    Script Date: 04-03-2020 22:55:07 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
from test
GO
/****** Object:  Table [dbo].[student]    Script Date: 04-03-2020 22:55:07 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[GETSTUDENT]    Script Date: 04-03-2020 22:55:07 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[copy_test]    Script Date: 04-03-2020 22:55:07 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[EMPLOYEE]    Script Date: 04-03-2020 22:55:07 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[EMPLOYEE] ([EMP_ID], [EMP_NAME], [MOBILE_NO], [DOB], [EMP_ADDRESS], [SALARY], [ZIP_CODE], [IS_ACTIVE], [CREATED_DATE], [MODIFIED_DATE]) VALUES (100, N'shagun', N'9868940221', CAST(N'1997-02-13' AS Date), N'Badarpur', 105000.0000, 110044, 1, CAST(N'2020-02-26T16:53:26.090' AS DateTime), NULL)
GO
INSERT [dbo].[EMPLOYEE] ([EMP_ID], [EMP_NAME], [MOBILE_NO], [DOB], [EMP_ADDRESS], [SALARY], [ZIP_CODE], [IS_ACTIVE], [CREATED_DATE], [MODIFIED_DATE]) VALUES (101, N'punita', N'8800996677', CAST(N'1996-04-05' AS Date), N'Faridabad', 85000.0000, 110042, 1, CAST(N'2020-02-26T16:56:09.390' AS DateTime), NULL)
GO
...
GO
/****** Object:  StoredProcedure [dbo].[CallUpdate_proc]    Script Date: 04-03-2020 22:55:07 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[proc1]    Script Date: 04-03-2020 22:55:07 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[proc2]    Script Date: 04-03-2020 22:55:07 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[TestShow_proc]    Script Date: 04-03-2020 22:55:07 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[UpdateTest_proc]    Script Date: 04-03-2020 22:55:07 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
